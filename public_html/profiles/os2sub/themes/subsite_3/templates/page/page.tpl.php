  ...
  <header class="flexy-header flexy-header--static">
    <div class="flexy-header__row flexy-header__row--first">
      <div class="container">
        <div class="flexy-row">
          ...
          <button
            class="flexy-header__sidebar-toggle sidr-toggle--right visible-xs">
    ...
    <div class="flexy-header__row flexy-header__row--second hidden-xs">
      <div class="container">
        ...
        <!-- Begin - navigation -->
        <nav
          class="flexy-header__navigation__wrapper flexy-header__navigation__wrapper--full-width"
          role="navigation">
          ...
          <div class="col-xs-12 col-sm-3">
            ...
            <nav class="social-icons"
              ...
              <ul class="flexy-list">
                ...
                <?php if ($theme_settings['social_links']['vimeo']['active']): ?>
                  <li>
                    <a
                      href="<?php print $theme_settings['social_links']['vimeo']['url']; ?>"
                      target="_blank"
            ...
            <?php if (!empty($theme_settings['layout']['footer']['description'])) : ?>
              ...
              <div class="sectioned--sitemap__description">
                <h3
                  class="heading-h5"><?php print $theme_settings['layout']['footer']['description']; ?></h3>
              </div>
              <!-- End - description -->
            <?php endif; ?>
