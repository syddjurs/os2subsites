  ...
  <div class='main-container container'>
    ...
    <div class='row'>
      ...
      <div class="col-sm-8  col-xs-12">          
        ...
        <?php if (theme_get_setting('welcome','os2subtheme')) :?>
      ...
      <?php endif;?>
      <?php if (theme_get_setting('large_news','os2subtheme')== 2) :?>
      ...
      <?php endif;?>
      <?php if (theme_get_setting('latest_news','os2subtheme')== 2) :?>
      <div class="latest-news-block">
        <?php 
        
      $view = views_get_view('svendborg_news_view');
      $view->set_display('svendborg_latest_news');
      $view->set_offset(theme_get_setting('large_news','os2subtheme'));
      $view->pre_execute();
      $view->execute();
     ...
     <?php endif;?>
      ...
      <div class="region region-sidebar-second col-sm-4 col-xs-12">
          <?php if (theme_get_setting('promoted_nodes','os2subtheme') ):?>
       <div class="frontpage-nodes-block <?php (theme_get_setting('promoted_nodes_location','os2subtheme') === 'slider')?  print 'hidden-sm hidden-md hidden-lg' : print ''?>">
        <?php //$block_search_form = module_invoke('search', 'block_view', 'search'); ?>
        <?php print _os2subtheme_block_render('views', 'frontpage_nodes-block'); ?>
      </div>
      <?php endif;?>
     <?php if (theme_get_setting('activites','os2subtheme')) :?>
      <div class="activites-block">
          <?php  print _os2subtheme_block_render('views', 'aktiviteter-block_2'); ?>
      </div>
     <?php endif;?>
      </div>
      
      <div class="clearfix"></div>
      <?php if (theme_get_setting('large_news','os2subtheme')==3) :?>
     ...
     <?php endif;?>
      ...
      <?php if (theme_get_setting('large_news','os2subtheme')==4) :?>
      <div class="news-block col-xs-12">
        <?php $view = views_get_view('svendborg_news_view');
     ...
     <?php endif;?>
      <?php if (theme_get_setting('latest_news','os2subtheme')== 3) :?>      
