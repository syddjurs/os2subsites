...
if (theme_get_setting('slider_overlay', 'os2subtheme')) {
...
$indicator_active_uri = file_create_url(drupal_get_path('theme', 'os2subtheme') . '/images/slider_active.png');
$indicator_inactive_uri = file_create_url(drupal_get_path('theme', 'os2subtheme') . '/images/slider_inactive.png');
...
$show_frontpage_nodes = (theme_get_setting('promoted_nodes', 'os2subtheme') && theme_get_setting('promoted_nodes_location', 'os2subtheme') === 'slider');
...
if ($show_frontpage_nodes) {
  ...
  $html .= _os2subtheme_block_render('views', 'frontpage_nodes-block');
  $html .= '</div>';
}
$html .= '</div>';//class="row"
$html .= '</div>';//class="container"
