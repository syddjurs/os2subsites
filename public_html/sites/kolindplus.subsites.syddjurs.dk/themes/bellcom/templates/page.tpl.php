      ...
      <footer class="footer">
			...
			<div class="contact-information">
				<div class="custom-contact-information">				
					<img src="http://smartsyddjurs.subsites.syddjurs.dk/sites/smartsyddjurs.subsites.syddjurs.dk/files/syddjurs_logo.png" alt="Syddjurs Kommune" class="custom-syddjurs-logo" />
